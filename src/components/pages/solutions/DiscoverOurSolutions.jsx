  ...
  return (
    <div>
      <div className='flex flex-col gap-2 justify-center items-center'>
        ...
        <div>
          <h1 className='text-gold font-cursive text-3xl font-bold uppercase text-center'>
            Discover Our Solutions
          </h1>
        </div>
        <div className='mb-40 mt-5'>
          <p className={`${styles.paragraph} text-center`}>
            At GATA Protocol, we are committed to revolutionizing the eCommerce <br /> landscape by
            leveraging cutting-edge technologies to address trust-
            <br />
            related challenges. Our decentralized eCommerce ecosystem incorporates <br />{' '}
            blockchain, smart contracts, Web3, AI, AR, and VR, all working in harmony to <br />{' '}
            provide you with a secure and transparent shopping experience. Here's how <br /> we
