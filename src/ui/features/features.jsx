        ...
        <div className='features_card' id='features_card w-full p-10'>
          ...
          <div className='card text-center rounded-sm bg-white h-67 w-80 p-10'>
            ...
            <p className='text-dark text-sm font-semibold'>
              Our platform streamlines the sales and logistics process, eliminating the need for
              middlemen and reducing transaction costs.
            </p>
          </div>
          <div className='card text-center rounded-sm bg-white h-67 w-80 p-10'>
            <div className='icon_border'>
            ...
            <h2 className='text-dark m-5 font-bold text-lg uppercase'>
              GLOBAL BUSINESS COMMUNITY NETWORK
            </h2>
            <p className='text-dark text-sm font-semibold'>
              Connect with potential buyers and sellers from around the world, expanding your reach
          ...
          <div className='card text-center rounded-sm bg-white h-67 w-80 p-10'>
            ...
            <h2 className='text-dark m-5 font-bold text-lg uppercase'>
              Secured and Trustless Payments Systems
            </h2>
            <p className='text-dark text-sm font-semibold'>
              Conduct transactions with confidence, knowing that your payments are secure and
              transparent.
            </p>
          </div>
          <div className='card text-center rounded-sm bg-white h-67 w-80 p-10'>
