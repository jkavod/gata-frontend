...
const economy = [
  {
    name: 'Analytics',
    description: 'Get a better understanding of GATA economy',
    href: '#',
    icon: ChartPieIcon,
  },
];
...
const community = [
  {
    name: 'Engagement',
    description: 'Join the GATA Community',
    href: '#',
...
const develop = [
  {
    name: 'Security',
    description: 'Your data are safe and secure',
    href: '#',
    icon: FingerPrintIcon,
  },
  {
    name: 'Integrations',
    description: 'Connect with our third-party tools',
    href: '#',
...
const token = [
  {
    ...
    description: 'Get to learn about Gata Blockchain',
    href: '#',
    icon: DocumentIcon,
  },
];
  ...
  return (
    <div className='bg-dark' id='head'>
      <header className='bg-dark sm:px-10 text-white' id='header_nav'>
        <nav
          className='mx-auto flex max-w-7xl items-center justify-between lg:px-8 text-white'
          id='nav'
          aria-label='Global'
        >
          ...
          <div className='hidden lg:flex lg:flex-1 lg:justify-end'>
            <a
              href='#'
              className='text-sm font-bold leading-6 text-dark bg-gold px-10 py-2 rounded-xl'
              id='btn'
            >
              Launch
            </a>
        ...
        <Dialog
          as='div'
          className='lg:hidden sm:px-15 overflow-hidden'
          open={mobileMenuOpen}
        ...
        <div className=' max-w-2l py-20 sm:py-10 lg:py-20'>
          <div className='text-center'>
            ...
            <p className='mt-4 text-lg leading-6 text-white'>
              GATA Protocol Transforming eCommerce for Communities with blockchain, AI, AR and VR
              Technologies.
            </p>
          ...
          <div className='text-center mt-20'>
            <img
              src={star_backfiller}
              alt=''
              className='left_img sm:z-10 sm:w-20'
              id='star_backfiller'
            />
            ...
            <img
              src={star_backfiller}
              alt=''
              className='right_img sm:z-10 sm:w-20 sm:mt-5'
              id='star_backfiller'
            />
          </div>
        </div>
