        ...
        <div>
            <section id='section_background'>
                <div className="body_sec">
                    <div className="text p-28">
                        ...
                        <a href="#" className='text-dark font-bold py-3 px-20 bg-gold rounded mt-20'>Learn More</a>
                    </div>
                    <img src={pentagon} alt="" className='w-2/5' />
                </div>
                <div className="body_sec">
                    <div className="text p-28">
                        ...
                        <a href="#" className='text-dark py-3 font-bold px-20 bg-gold rounded mt-20'>Learn More</a>
                    </div>
                    <img src={atom_sphere} alt="" className='w-2/5' />
                </div>
            </section>
            <section id='section_background'>
                <div className="body_sec">
                    ...
                    <img src={block_cage} alt="" className='w-2/5' />
                </div>
                <div className="body_sec">
                    <div className="text p-28">
                    ...
                    <img src={box} alt="" className='w-2/5' />
                </div>
            </section>
            <section id='section_background'>
                <div className="body_sec">
                    ...
                    <img src={ball_pentagon} alt="" className='w-2/5' />
                </div>
                <div className="body_sec">
                    <div className="text p-28">
                    ...
                    <img src={atom_cube} alt="" className='w-2/5' />
                </div>
            </section>
            <section id='section' className='bg-white'>
                <div className="body_sec">
                    ...
                    <img src={penta} alt="" className='w-2/5' />
                </div>
            </section>
