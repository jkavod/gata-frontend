    ...
    <div>
      <section id='section_background'>
        <div className='body_sec'>
          <div
            className={`text p-28 fly-in-right-element ${isVisible ? 'scroll-in' : ''}`}
            id='fly-in-right-element'
          >
            <h1 className={`text-gold font-bold my-5 text-2xl`}>GATAChain</h1>
            <p className='text-dark mb-6'>
              Reshaping the future of eCommerce and the experience of shopping powered by blockchain
              ledger technology.
            </p>
            <a href='#' className='text-dark font-bold py-3 px-20 bg-gold rounded mt-20' id='btn'>
              Learn More
            </a>
          </div>
          <img
            src={pentagon}
            alt=''
            className={`w-2/5 fly-in-left-element ${isVisible ? 'scroll-in' : ''}`}
            id='fly-in-left-element'
          />
        </div>
        <div className='body_sec'>
          <div
          ...
          >
            ...
            <p className='text-white mb-6'>
              Discover a new era of shopping via a decentralized marketplace that modernizes product
              and supply chain management.
            </p>
            <a href='#' className='text-dark py-3 font-bold px-20 bg-gold rounded mt-20' id='btn'>
              Learn More
            </a>
          </div>
          <img
      ...
      <section id='section_background'>
        <div className='body_sec'>
          ...
          >
            ...
            <p className='text-dark mb-6'>
              Explore the next generation "decentralized logistics and delivery service" that
              seamlessly bridges sellers to buyers.
            </p>
            <a href='#' className='text-dark font-bold py-3 px-20 bg-gold rounded mt-20' id='btn'>
              Learn More
            </a>
      ...
      <section id='section_background'>
        ...
        <div className='body_sec'>
          ...
          >
            ...
            <p className='text-white mb-6'>
              Immerse yourself in the future of shopping experiences with AI, AR, and VR
              Technologies.
            </p>
            <a href='#' className='text-dark py-3 font-bold px-20 bg-gold rounded mt-20' id='btn'>
              Learn More
      ...
      <section id='section' className='bg-white'>
        <div className='body_sec'>
          ...
          >
            ...
            <p className='text-dark mb-6'>
              Easily Conduct transactions globally with the $GATA Coin and gain exclusive community
              benefits as a membership NFT holder.
            </p>
            <a href='#' className='text-dark font-bold py-3 px-20 bg-gold rounded mt-20' id='btn'>
              Learn More
            </a>
